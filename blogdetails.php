...
<header class="main-header header-style-two">
        ...
        <div class="header-upper">
            <div class="auto-container">
				<div class="inner-container">
					<!-- Logo Box -->
					<div class="logo-box">
						<div class="logo"><a href="home.php"><img src="images/logo.png" alt="" title=""></a></div>
					</div>
        ...
        <div class="sticky-header">
            <div class="auto-container">
                ...
                <!-- Logo -->
                <div class="logo">
                    <a href="home.php" title=""><img src="images/logo.png" alt="" title=""></a>
                </div>
...
if (isset($_GET['id'])) {
	...
	$sql = "SELECT blogheader, blogtext, id, image FROM blog  where id=$id ";
	...
	if ($result->num_rows > 0) {
		while ($row = $result->fetch_assoc()) {
			...
			$broken_header1 = breakTextWithBR($header, 70);
			$broken_text1 = breakTextWithBR($text, 70);
			



				
				echo	'<div class="news-block_one-inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms" style=" margin-left:  260px;">';
					...
					echo		'<div class="news-block_one-text">'.$broken_text1.'</div>';
					echo   		'<button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="del('.$id.')">Back</button>';
					echo	'</div>';
					echo '</div>';
	...
	<footer class="main-footer" style="background-image: url(images/pattern-8.png)">
		...
		<div class="auto-container">
			...
			<div class="main-footer_bottom">
				<div class="d-flex justify-content-between align-items-center flex-wrap">
					<div class="footer_copyright">Copyright 2023 merit All Rights Reserved</div>
					<!-- Scroll To Top -->
